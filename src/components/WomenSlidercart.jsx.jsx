...
const WomenSlidercart = () => {
    return (
        <div className='w-full max-w-7xl mx-auto mt-20 px-4 sm:px-6 lg:px-8'>
            <h1 className='text-3xl md:text-4xl mb-10 text-center md:text-left'>Women's Collection</h1>
            <Carousel
                showArrows={true}
...
const data = [
    {
        ...
        img: "../src/Images/Mens/ShalwarKameez 2.jpg",
    ...
    {
        collection: "Women's Collection",
        img: "../src/Images/Mens/ShalwarKameez 9.jpg",
        pera: "Style with our exclusive range of branded clothing.",
    },
    {
        collection: "Women's Collection",
